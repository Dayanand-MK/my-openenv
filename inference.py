...
Reads credentials from environment variables:
  ...
  MODEL_NAME     The model identifier   (default: mistralai/Mistral-7B-Instruct-v0.3)
  HF_TOKEN       Your API key (no default)
...
HF_TOKEN = os.environ.get("HF_TOKEN")   # NO default — required by checklist
...
# ─────────────────────────────────────────────
#  Logging helpers  (required START/STEP/END format)
# ─────────────────────────────────────────────
